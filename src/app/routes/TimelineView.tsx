...
export function TimelineView() {
  ...
  const currentDatePosition =
    minDate && maxDate && now >= minDate && now <= maxDate
  ...
  const spacing =
    viewMode === 'compact' ? 'space-y-2' : viewMode === 'comfortable' ? 'space-y-3' : 'space-y-4'
    ...
    <div className="space-y-6">
      ...
      {cellsWithData.length === 0 ? (
        <div className="text-center py-12 bg-white dark:bg-gray-800 rounded-lg shadow">
          ...
          <p className="text-gray-500 mt-2">Cells in this project don't have schedule dates yet.</p>
        </div>
      ) : (
        <>
          {/* Controls Bar */}
          ...
          <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 relative overflow-x-auto">
            ...
            <div className="mb-4 flex items-center justify-between text-sm text-gray-500">
              ...
              <div className="flex items-center space-x-2">
                <span className="px-2 py-1 bg-emerald-100 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 rounded text-xs font-medium">
                  On Track
                </span>
                ...
                <span className="px-2 py-1 bg-rose-100 text-rose-800 dark:bg-rose-900/30 dark:text-rose-300 rounded text-xs font-medium">
                  Late
                </span>
              </div>
            </div>
                    ...
                    return (
                      <div key={cell.id} className="relative group">
                        ...
                        >
                          ...
                          >
                            <span className="truncate">{cell.schedule?.phase || 'N/A'}</span>
                          </div>
                        </div>
