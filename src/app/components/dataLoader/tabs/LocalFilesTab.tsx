      ...
      {!isIngesting && (
        <div className="flex justify-end pt-2">
          <button
            ...
            className="inline-flex items-center gap-2 px-4 py-2 border border-transparent typography-body-strong rounded-md shadow-sm text-white bg-gray-800 dark:bg-gray-200 dark:text-gray-900 hover:bg-gray-900 dark:hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
