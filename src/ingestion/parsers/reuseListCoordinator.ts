...
export async function loadAllReuseLists(
  ...
  const errors: string[] = [];
  const allParsedRows: Array<{ parsed: ParsedAssetRow; workbookConfig: WorkbookConfig; source: 'INTERNAL' | 'DESIGNOS' }> = [];
 ...
 */
async function discoverReuseWorkbooks(
  dataRoot: string
  ...
  const configs: Array<{
    ...
    // INTERNAL workbooks
    { source: 'INTERNAL', subdir: '03_Simulation/01_Equipment_List', assetType: 'Riser', filename: 'GLOBAL_ZA_REUSE_LIST_RISERS.xlsx' },
    { source: 'INTERNAL', subdir: '03_Simulation/01_Equipment_List', assetType: 'TipDresser', filename: 'GLOBAL_ZA_REUSE_LIST_TIP_DRESSER.xlsx' },
    { source: 'INTERNAL', subdir: '03_Simulation/01_Equipment_List', assetType: 'TMSGun', filename: 'GLOBAL_ZA_REUSE_LIST_TMS_WG.xlsx' },

    // DesignOS workbooks
    { source: 'DESIGNOS', subdir: 'DesignOS/01_Equipment_List', assetType: 'Riser', filename: 'GLOBAL_ZA_REUSE_LIST_RISERS.xlsx' },
    { source: 'DESIGNOS', subdir: 'DesignOS/01_Equipment_List', assetType: 'TipDresser', filename: 'GLOBAL_ZA_REUSE_LIST_TIP_DRESSER.xlsx' },
    { source: 'DESIGNOS', subdir: 'DesignOS/01_Equipment_List', assetType: 'TMSGun', filename: 'GLOBAL_ZA_REUSE_LIST_TMS_WG.xlsx' }
  ];
 ...
 */
function applyPrecedenceAndDedupe(
  records: ReuseRecord[],
  errors: string[]
): ReuseRecord[] {
