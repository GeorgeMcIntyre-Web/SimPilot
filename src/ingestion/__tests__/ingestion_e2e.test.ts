...
const REALISTIC_SIMULATION_SHEET = [
  ...
  // Row 4+: Data rows
  ['Underbody', 'BN_B05', 'OP-10', 'R-001', 'Spot Welding', 'John Smith', 100, 95, 85, 90, 75, 80, 70, 65],
  ['Underbody', 'BN_B05', 'OP-20', 'R-002', 'Sealing', 'Jane Doe', 80, 75, 70, 60, 50, 40, 30, 20],
  ['Side Body', 'BN_B10', 'OP-30', 'R-003', 'Spot Welding', 'Bob Wilson', 100, 100, 100, 100, 100, 100, 100, 100]
]
...
describe('E2E: Vacuum Parser', () => {
  it('vacuums all metric columns from simulation sheet', () => {
    ...
    expect(firstRow.area).toBe('Underbody')
  ...
  it('handles new columns without code changes (vacuum principle)', () => {
    ...
    const sheetWithNewColumn = [
      ...
      [null],
      [null],
      ['AREA', 'ASSEMBLY LINE', 'STATION', 'ROBOT', 'APPLICATION', 'LASER SAFETY CHECK', 'NEW FUTURE COLUMN'],
