...
function createMockLogger(): Logger & { debug: ReturnType<typeof vi.fn>; warn: ReturnType<typeof vi.fn> } {
    return {
        debug: vi.fn(),
        warn: vi.fn()
    }
...
describe('linkAssetsToSimulation', () => {
    ...
    describe('data merging', () => {
        ...
        it('merges asset metadata into cell', () => {
            const cells = [createCell({ id: 'c1', stationId: 'AREA1|010', metadata: { existing: 'value' } })]
            const assets = [createRobot({
                id: 'r1',
                stationId: 'AREA1|010',
